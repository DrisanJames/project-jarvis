...
func (cb *ContextBuilder) BuildSampleContext() RenderContext {
	...
	return RenderContext{
		...
		"system": map[string]interface{}{
			...
			"current_day":         now.Day(),
			"current_weekday":     now.Weekday().String(),
			"unsubscribe_url":     "https://projectjarvis.io/track/unsubscribe/preview",
			"preferences_url":     "https://projectjarvis.io/preferences?token=preview",
			"view_in_browser_url": "https://projectjarvis.io/view?id=preview",
		},
		"now":   now,
