...
const tabs: Tab[] = [
  ...
  { id: 'campaign-center', label: 'Campaign Center', icon: faBullhorn, description: 'Create, schedule and monitor your email campaigns.', childIds: ['campaign-center', 'pmta-wizard', 'send-day', 'draft-board', 'drip-lanes', 'property-ledger', 'schedule', 'scheduling-copilot'] },
...
const CampaignCenterSection: React.FC<{
  ...
  const { organization } = useAuth();
  const subTab = (['pmta-wizard', 'send-day', 'draft-board', 'drip-lanes', 'property-ledger', 'marketing-agent', 'schedule', 'scheduling-copilot'].includes(activeSubTab)) ? activeSubTab : 'campaign-center';
